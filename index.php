    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-lg-8 offset-lg-2 mb-5 pt-3 pb-5 pr-5 pl-5 text-center" data-aos="fade-up" data-aos-offset="10">
                ...
                <a href="<?php echo get_bloginfo('url');?>/web-development/" class="orange-hover btn btn-primary primary-bg text-white pl-4 pr-4 mb-2">Learn More</a>
                <a href="https://fragmentwebworks.com/" class="orange-hover btn btn-primary primary-bg text-white pl-4 pr-4 mb-2">Visit Fragment Web Works</a>
